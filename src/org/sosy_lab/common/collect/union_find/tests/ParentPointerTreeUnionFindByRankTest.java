...
public class ParentPointerTreeUnionFindByRankTest {
  private ParentPointerTreeUnionFind<Integer> integerUnionFind;

  @Before
  public void setup() {
    integerUnionFind = new ParentPointerTreeUnionFind<>(UnionType.UNION_BY_RANK);
  }
  ...
  public void testUnion_StringElements() {
    ...
    ParentPointerTreeUnionFind<String> stringUnionFind =
        new ParentPointerTreeUnionFind<>(UnionType.UNION_BY_RANK);
